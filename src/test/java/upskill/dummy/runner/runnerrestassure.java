...
glue = { "upskill.dummy.restAssure.StepDefination", "upskill.utilities" }, 
tags = {"@regression"}, 
plugin = { "pretty", "html:target/cucumber-htmlreport", "json:target/cucumber-report.json",
"com.cucumber.listener.ExtentCucumberFormatter:target/cucumber-reports.html" }, 
monochrome = true)

public class runnerrestassure extends AbstractTestNGCucumberTests {
	@AfterClass
